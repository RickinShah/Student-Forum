...
public class StudentForum extends Applet implements MouseListener, ActionListener {
    ...
    void qaMenuQuestion() {
        ...
        questionLabel.setFont(new Font("", Font.BOLD, 16));
    ...
    void qaMenuAnswer() {
        ...
        answerLabel.setFont(new Font("", Font.PLAIN, 16));
    ...
    void askQuestion() {
        ...
        askQuestionTextArea.setBackground(c3);
    ...
    void questionSubmitted() {
        ...
        questionSubmittedLabel.setBackground(c);
...
/*
 * <applet code="StudentForum.class" width="500" height="300">
 * </applet>
 */
